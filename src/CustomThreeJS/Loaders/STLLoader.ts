...
export const STLLoader = function ( manager:any ) {
...
STLLoader.prototype = {
	...
	load: function ( url:any, onLoad:any, onProgress:any, onError:any ) {
	...
	setCrossOrigin: function ( value:any ) {
	...
	parse: function ( data:any ) {
		...
		let isBinary = function () {
			...
			for ( let index = 0; index < fileLength; index ++ ) {
				...
				if ( reader.getUint8( index ) > 127 ) {//reader.getUint8( index, false ) > 127
...
// 	DataView = function( buffer:any, byteOffset:any, byteLength:any ) {
...
// 		_getCharCodes: function( buffer:any, start:any, length:any ) {
...
// 		_getBytes: function ( length:any, byteOffset:any, littleEndian:any ) {
...
// 		getFloat64: function ( byteOffset:any, littleEndian:any ) {
...
// 		getFloat32: function ( byteOffset:any, littleEndian:any ) {
...
// 		getInt32: function ( byteOffset:any, littleEndian:any ) {
...
// 		getUint32: function ( byteOffset:any, littleEndian:any ) {

// 			return this.getInt32( byteOffset, littleEndian ) >>> 0;

// 		},

// 		getInt16: function ( byteOffset:any, littleEndian:any ) {

// 			return ( this.getUint16( byteOffset, littleEndian ) << 16 ) >> 16;

// 		},

// 		getUint16: function ( byteOffset:any, littleEndian:any ) {
...
// 		getInt8: function ( byteOffset:any ) {

// 			return ( this.getUint8( byteOffset ) << 24 ) >> 24;

// 		},

// 		getUint8: function ( byteOffset:any ) {
